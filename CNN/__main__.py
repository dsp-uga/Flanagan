...
def main():
    ...
    parser.add_argument("--test_data_path", default = "CNN/Data/Test/",
    ...
    parser.add_argument("--test_rec", default = "CNN/Data/TFRecords/test.tfrecord",
    ...
    parser.add_argument("--prediction_save_path", default = "CNN/Data/",
    ...
    parser.add_argument("--stitch_input_file", default = "CNN/Data/prediction_chunks.txt",
    ...
    parser.add_argument("--stitch_data_path", default = "CNN/Data/Predictions/",
        help = "The path to the stored prediction files for each chunk of test data.")
    parser.add_argument("--stitch_output_path", default = "CNN/Data/FinalPreds/",
